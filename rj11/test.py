...
# lines = ['10 21', '973 991', '1391 1568', '111 2073', '1030 1312', '125 465', '1527 1559', '1654 2162', '1099 2029', '2086 2395', '2404 2438', '2414 2431', '613 1469', '742 1647', '1245 2196', '259 1991', '379 1351', '285 493', '1143 2215', '1669 2259', '1832 2432', '2039 2233']
...
class liste_parsee:
    ...
    def __init__(self, liste_base):
        ...
        self.occurence = self.est_possible()

    def __str__(self):
        return f"{self.liste_parsee}"
    ...
    def genere_liste_parsee(self, liste):
        ...
        # print(liste_formatee)
        # print(mini, maxi)
        for y in range(len(liste_formatee)):
            for x in range(len(liste_formatee[y])):
